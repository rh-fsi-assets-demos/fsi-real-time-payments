...
import rtp.demo.domain.OBWriteDomesticStandingOrder3DataInitiationCreditorAccount;
import rtp.demo.domain.OBWriteDomesticStandingOrder3DataInitiationDebtorAccount;
import rtp.demo.domain.OBWriteDomesticStandingOrder3DataInitiationFinalPaymentAmount;
import rtp.demo.domain.OBWriteDomesticStandingOrder3DataInitiationFirstPaymentAmount;
import rtp.demo.domain.OBWriteDomesticStandingOrder3DataInitiationRecurringPaymentAmount;
...
//	@JsonProperty("SupplementaryData")
	...
	public OBWriteDomesticStandingOrder3DataInitiation recurringPaymentDateTime(
			OffsetDateTime recurringPaymentDateTime) {
		this.recurringPaymentDateTime = recurringPaymentDateTime;
		return this;
	}

	/**
	 * The date on which the first recurring payment for a Standing Order schedule
	 * will be made. Usage: This must be populated only if the first recurring date
	 * is different to the first payment date.All dates in the JSON payloads are
	...
	public OBWriteDomesticStandingOrder3DataInitiation firstPaymentAmount(
			OBWriteDomesticStandingOrder3DataInitiationFirstPaymentAmount firstPaymentAmount) {
	...
	public void setFirstPaymentAmount(
			OBWriteDomesticStandingOrder3DataInitiationFirstPaymentAmount firstPaymentAmount) {
		this.firstPaymentAmount = firstPaymentAmount;
	}

	public OBWriteDomesticStandingOrder3DataInitiation recurringPaymentAmount(
			OBWriteDomesticStandingOrder3DataInitiationRecurringPaymentAmount recurringPaymentAmount) {
	...
	public void setRecurringPaymentAmount(
			OBWriteDomesticStandingOrder3DataInitiationRecurringPaymentAmount recurringPaymentAmount) {
		this.recurringPaymentAmount = recurringPaymentAmount;
	}

	public OBWriteDomesticStandingOrder3DataInitiation finalPaymentAmount(
			OBWriteDomesticStandingOrder3DataInitiationFinalPaymentAmount finalPaymentAmount) {
	...
	public void setFinalPaymentAmount(
			OBWriteDomesticStandingOrder3DataInitiationFinalPaymentAmount finalPaymentAmount) {
		this.finalPaymentAmount = finalPaymentAmount;
	}

	public OBWriteDomesticStandingOrder3DataInitiation debtorAccount(
	...
	public OBWriteDomesticStandingOrder3DataInitiation creditorAccount(
			OBWriteDomesticStandingOrder3DataInitiationCreditorAccount creditorAccount) {
	...
	public boolean equals(java.lang.Object o) {
		...
		return Objects.equals(this.frequency, obWriteDomesticStandingOrder3DataInitiation.frequency)
				...
				&& Objects.equals(this.firstPaymentDateTime,
						obWriteDomesticStandingOrder3DataInitiation.firstPaymentDateTime)
				&& Objects.equals(this.recurringPaymentDateTime,
						obWriteDomesticStandingOrder3DataInitiation.recurringPaymentDateTime)
				&& Objects.equals(this.finalPaymentDateTime,
						obWriteDomesticStandingOrder3DataInitiation.finalPaymentDateTime)
				&& Objects.equals(this.firstPaymentAmount,
						obWriteDomesticStandingOrder3DataInitiation.firstPaymentAmount)
				&& Objects.equals(this.recurringPaymentAmount,
						obWriteDomesticStandingOrder3DataInitiation.recurringPaymentAmount)
				&& Objects.equals(this.finalPaymentAmount,
						obWriteDomesticStandingOrder3DataInitiation.finalPaymentAmount)
		...
		// obWriteDomesticStandingOrder3DataInitiation.supplementaryData);
	}

	@Override
	public int hashCode() {
		return Objects.hash(frequency, reference, numberOfPayments, firstPaymentDateTime, recurringPaymentDateTime,
				finalPaymentDateTime, firstPaymentAmount, recurringPaymentAmount, finalPaymentAmount, debtorAccount,
				creditorAccount);// , supplementaryData);
	}

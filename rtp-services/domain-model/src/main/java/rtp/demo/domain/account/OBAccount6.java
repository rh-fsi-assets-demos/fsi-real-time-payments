...
import rtp.demo.domain.account.OBBranchAndFinancialInstitutionIdentification50;
...
public class OBAccount6 {
	...
	private OBBranchAndFinancialInstitutionIdentification50 servicer = new OBBranchAndFinancialInstitutionIdentification50();
	...
	public boolean equals(java.lang.Object o) {
		...
		return Objects.equals(this.accountId, obAccount6.accountId) && Objects.equals(this.status, obAccount6.status)
	...
	public int hashCode() {
		return Objects.hash(accountId, status, statusUpdateDateTime, currency, accountType, accountSubType, description,
				nickname, openingDate, maturityDate, account, servicer);
	}

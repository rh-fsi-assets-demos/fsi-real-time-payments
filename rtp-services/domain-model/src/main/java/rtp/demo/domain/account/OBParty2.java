...
import rtp.demo.domain.account.OBExternalPartyType1Code;
import rtp.demo.domain.account.OBParty2Address;
import rtp.demo.domain.account.OBPartyRelationships1;
...
//	(regexp="\+[0-9]{1,3}-[0-9()+\-]{1,30}")
	...
	public boolean equals(java.lang.Object o) {
		...
		return Objects.equals(this.partyId, obParty2.partyId) && Objects.equals(this.partyNumber, obParty2.partyNumber)
				...
				&& Objects.equals(this.phone, obParty2.phone) && Objects.equals(this.mobile, obParty2.mobile)

...
import rtp.demo.domain.account.OBReadProduct2DataOtherProductTypeCreditInterest;
import rtp.demo.domain.account.OBReadProduct2DataOtherProductTypeLoanInterest;
import rtp.demo.domain.account.OBReadProduct2DataOtherProductTypeOtherFeesCharges;
import rtp.demo.domain.account.OBReadProduct2DataOtherProductTypeOverdraft;
import rtp.demo.domain.account.OBReadProduct2DataOtherProductTypeProductDetails;
import rtp.demo.domain.account.OBReadProduct2DataOtherProductTypeRepayment;

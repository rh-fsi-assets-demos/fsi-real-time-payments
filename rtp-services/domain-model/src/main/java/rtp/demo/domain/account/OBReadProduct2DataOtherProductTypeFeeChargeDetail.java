...
import rtp.demo.domain.account.OBFeeCategory1Code;
import rtp.demo.domain.account.OBFeeFrequency1Code2;
import rtp.demo.domain.account.OBFeeFrequency1Code3;
import rtp.demo.domain.account.OBFeeType1Code;
import rtp.demo.domain.account.OBInterestRateType1Code1;
import rtp.demo.domain.account.OBOtherCodeType10;
import rtp.demo.domain.account.OBOtherCodeType16;
import rtp.demo.domain.account.OBOtherCodeType17;
import rtp.demo.domain.account.OBOtherCodeType18;
import rtp.demo.domain.account.OBOtherFeeChargeDetailType;
import rtp.demo.domain.account.OBReadProduct2DataOtherProductTypeFeeApplicableRange;
import rtp.demo.domain.account.OBReadProduct2DataOtherProductTypeFeeChargeCap;

...
import rtp.demo.domain.account.OBInterestFixedVariableType1Code;
import rtp.demo.domain.account.OBReadProduct2DataOtherProductTypeLoanInterestLoanInterestFeesCharges;
import rtp.demo.domain.account.OBReadProduct2DataOtherProductTypeLoanInterestOtherLoanProviderInterestRateType;

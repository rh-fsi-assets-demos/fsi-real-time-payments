...
import rtp.demo.domain.account.OBInterestCalculationMethod1Code;
import rtp.demo.domain.account.OBOtherCodeType10;
import rtp.demo.domain.account.OBReadProduct2DataOtherProductTypeLoanInterestLoanInterestFeesCharges;
import rtp.demo.domain.account.OBReadProduct2DataOtherProductTypeLoanInterestLoanInterestTierBand;

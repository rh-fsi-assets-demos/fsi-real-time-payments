...
import rtp.demo.domain.account.OBFeeFrequency1Code0;
import rtp.demo.domain.account.OBFeeFrequency1Code1;
import rtp.demo.domain.account.OBInterestRateType1Code0;
import rtp.demo.domain.account.OBOtherCodeType11;
import rtp.demo.domain.account.OBOtherCodeType12;
import rtp.demo.domain.account.OBOtherCodeType13;
import rtp.demo.domain.account.OBOtherCodeType14;
import rtp.demo.domain.account.OBOverdraftFeeType1Code;
import rtp.demo.domain.account.OBReadProduct2DataOtherProductTypeOverdraftOverdraftFeeChargeCap;

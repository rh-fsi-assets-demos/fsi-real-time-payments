...
import rtp.demo.domain.account.OBActiveOrHistoricCurrencyAndAmount11;
import rtp.demo.domain.account.OBActiveOrHistoricCurrencyAndAmount2;
import rtp.demo.domain.account.OBActiveOrHistoricCurrencyAndAmount3;
import rtp.demo.domain.account.OBActiveOrHistoricCurrencyAndAmount4;
import rtp.demo.domain.account.OBBranchAndFinancialInstitutionIdentification51;
import rtp.demo.domain.account.OBCashAccount51;
import rtp.demo.domain.account.OBExternalStandingOrderStatus1Code;

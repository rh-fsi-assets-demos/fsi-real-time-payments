...
import rtp.demo.domain.account.OBExternalStatementType1Code;
import rtp.demo.domain.account.OBStatement2StatementAmount;
import rtp.demo.domain.account.OBStatement2StatementBenefit;
import rtp.demo.domain.account.OBStatement2StatementDateTime;
import rtp.demo.domain.account.OBStatement2StatementFee;
import rtp.demo.domain.account.OBStatement2StatementInterest;
import rtp.demo.domain.account.OBStatement2StatementRate;
import rtp.demo.domain.account.OBStatement2StatementValue;

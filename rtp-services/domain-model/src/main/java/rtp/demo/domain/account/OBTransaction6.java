...
import rtp.demo.domain.account.OBActiveOrHistoricCurrencyAndAmount10;
import rtp.demo.domain.account.OBActiveOrHistoricCurrencyAndAmount9;
import rtp.demo.domain.account.OBBankTransactionCodeStructure1;
import rtp.demo.domain.account.OBBranchAndFinancialInstitutionIdentification61;
import rtp.demo.domain.account.OBBranchAndFinancialInstitutionIdentification62;
import rtp.demo.domain.account.OBCashAccount60;
import rtp.demo.domain.account.OBCashAccount61;
import rtp.demo.domain.account.OBCreditDebitCode1;
import rtp.demo.domain.account.OBCurrencyExchange5;
import rtp.demo.domain.account.OBEntryStatus1Code;
import rtp.demo.domain.account.OBMerchantDetails1;
import rtp.demo.domain.account.OBSupplementaryData1;
import rtp.demo.domain.account.OBTransactionCardInstrument1;
import rtp.demo.domain.account.OBTransactionCashBalance;
import rtp.demo.domain.account.OBTransactionMutability1Code;
import rtp.demo.domain.account.ProprietaryBankTransactionCodeStructure1;
...
public class OBTransaction6 {
	...
	@Valid
	private List<String> statementReference = new ArrayList<String>();
	...
	@JsonProperty("Amount")
	private OBActiveOrHistoricCurrencyAndAmount9 amount = new OBActiveOrHistoricCurrencyAndAmount9();

	@JsonProperty("ChargeAmount")
	private OBActiveOrHistoricCurrencyAndAmount10 chargeAmount = new OBActiveOrHistoricCurrencyAndAmount10();

	@JsonProperty("CurrencyExchange")
	private OBCurrencyExchange5 currencyExchange = new OBCurrencyExchange5();

	@JsonProperty("BankTransactionCode")
	private OBBankTransactionCodeStructure1 bankTransactionCode = new OBBankTransactionCodeStructure1();

	@JsonProperty("ProprietaryBankTransactionCode")
	private ProprietaryBankTransactionCodeStructure1 proprietaryBankTransactionCode = new ProprietaryBankTransactionCodeStructure1();

	@JsonProperty("Balance")
	private OBTransactionCashBalance balance = new OBTransactionCashBalance();

	@JsonProperty("MerchantDetails")
	private OBMerchantDetails1 merchantDetails = new OBMerchantDetails1();

	@JsonProperty("CreditorAgent")
	private OBBranchAndFinancialInstitutionIdentification61 creditorAgent = new OBBranchAndFinancialInstitutionIdentification61();

	@JsonProperty("CreditorAccount")
	private OBCashAccount60 creditorAccount = new OBCashAccount60();

	@JsonProperty("DebtorAgent")
	private OBBranchAndFinancialInstitutionIdentification62 debtorAgent = new OBBranchAndFinancialInstitutionIdentification62();

	@JsonProperty("DebtorAccount")
	private OBCashAccount61 debtorAccount = new OBCashAccount61();

	@JsonProperty("CardInstrument")
	private OBTransactionCardInstrument1 cardInstrument = new OBTransactionCardInstrument1();
	...
	public OBTransaction6 proprietaryBankTransactionCode(
	...
	public int hashCode() {
		return Objects.hash(accountId, transactionId, transactionReference, statementReference, creditDebitIndicator,
				status, transactionMutability, bookingDateTime, valueDateTime, transactionInformation, addressLine,
				amount, chargeAmount, currencyExchange, bankTransactionCode, proprietaryBankTransactionCode, balance,
				merchantDetails, creditorAgent, creditorAccount, debtorAgent, debtorAccount, cardInstrument,
				supplementaryData);
	}

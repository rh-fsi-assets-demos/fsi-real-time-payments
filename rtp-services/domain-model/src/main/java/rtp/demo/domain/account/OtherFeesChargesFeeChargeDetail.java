...
import rtp.demo.domain.account.FeeApplicableRange;
import rtp.demo.domain.account.OtherApplicationFrequency1;
import rtp.demo.domain.account.OtherCalculationFrequency1;
import rtp.demo.domain.account.OtherFeeCategoryType;
import rtp.demo.domain.account.OtherFeeRateType1;
import rtp.demo.domain.account.OtherFeeType1;
import rtp.demo.domain.account.OtherFeesChargesFeeChargeCap;
